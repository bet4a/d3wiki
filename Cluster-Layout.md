...
<a name="cluster" href="Cluster-Layout#cluster">#</a> d3.layout.<b>cluster</b>()
...
<a name="sort" href="Cluster-Layout#sort">#</a> cluster.<b>sort</b>([<i>comparator</i>])
...
<a name="children" href="Cluster-Layout#children">#</a> cluster.<b>children</b>([<i>children</i>])
...
<a name="nodes" href="Cluster-Layout#nodes">#</a> cluster.<b>nodes</b>(<i>root</i>)
...
<a name="links" href="Cluster-Layout#links">#</a> cluster.<b>links</b>(<i>nodes</i>)
...
<a name="separation" href="Cluster-Layout#separation">#</a> cluster.<b>separation</b>([<i>separation</i>])
...
<a name="size" href="Cluster-Layout#size">#</a> cluster.<b>size</b>([<i>size</i>])
