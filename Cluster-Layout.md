...
<a name="cluster" href="#wiki-cluster">#</a> d3.layout.<b>cluster</b>()
...
<a name="_cluster" href="#wiki-_cluster">#</a> <b>cluster</b>(<i>root</i>)
<br><a name="nodes" href="#wiki-nodes">#</a> cluster.<b>nodes</b>(<i>root</i>)
...
<a name="links" href="#wiki-links">#</a> cluster.<b>links</b>(<i>nodes</i>)
...
<a name="children" href="#wiki-children">#</a> cluster.<b>children</b>([<i>children</i>])
...
<a name="sort" href="#wiki-sort">#</a> cluster.<b>sort</b>([<i>comparator</i>])
...
<a name="separation" href="#wiki-separation">#</a> cluster.<b>separation</b>([<i>separation</i>])
...
<a name="size" href="#wiki-size">#</a> cluster.<b>size</b>([<i>size</i>])
...
<a name="value" href="#wiki-value">#</a> cluster.<b>value</b>([<i>value</i>])
