...
<a name="pack" href="#wiki-pack">#</a> d3.layout.<b>pack</b>()
...
<a name="_pack" href="#wiki-_pack">#</a> <b>pack</b>(<i>root</i>)
<br><a name="nodes" href="#wiki-nodes">#</a> pack.<b>nodes</b>(<i>root</i>)
...
<a name="links" href="#wiki-links">#</a> pack.<b>links</b>(<i>nodes</i>)
...
<a name="children" href="#wiki-children">#</a> pack.<b>children</b>([<i>children</i>])
...
<a name="sort" href="#wiki-sort">#</a> pack.<b>sort</b>([<i>comparator</i>])
...
<a name="value" href="#wiki-value">#</a> pack.<b>value</b>([<i>value</i>])
...
<a name="size" href="#wiki-size">#</a> pack.<b>size</b>([<i>size</i>])

If *size* is specified, sets the available layout size to the specified two-element array of numbers representing *x* and *y*. If *size* is not specified, returns the current size, which defaults to 1×1.

<a name="radius" href="#wiki-radius">#</a> pack.<b>radius</b>([<i>radius</i>])
...
<a name="padding" href="#wiki-padding">#</a> pack.<b>padding</b>([<i>padding</i>])
