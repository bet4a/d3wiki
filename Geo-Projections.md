...
Several common projections are included with default build of D3; these are highlighted green (*). Numerous less-common projections are available in the [extended geographic projections plugin](https://github.com/d3/d3-plugins/tree/master/geo/projection) and the [polyhedral projection plugin](https://github.com/d3/d3-plugins/tree/master/geo/polyhedron).
...
<table class="highlight">
  ...
  <tr height="146" valign="top">
    ...
    <td>d3.geo.quarticAuthalic<br><a href="http://bl.ocks.org/4463175"><img src="https://raw.github.com/gist/4463175/thumbnail.png" width="202"></a></td>
