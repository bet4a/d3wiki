...
A shape generator, such as that returned by [d3.svg.arc](SVG-Shapes#wiki-arc), is both an object and a function. That is: you can call the shape like any other function, and the shape has additional methods that change its behavior. Like other classes in D3, shapes follow the method chaining pattern where setter methods return the shape itself, allowing multiple setters to be invoked in a concise statement.
...
<a name="svg_rect" href="SVG-Shapes#wiki-svg_rect">#</a> svg:<b>rect</b> x="0" y="0" width="0" height="0" rx="0" ry="0"
...
<a name="svg_circle" href="SVG-Shapes#wiki-svg_circle">#</a> svg:<b>circle</b> cx="0" cy="0" r="0"
...
<a name="svg_ellipse" href="SVG-Shapes#wiki-svg_ellipse">#</a> svg:<b>ellipse</b> cx="0" cy="0" rx="0" ry="0"
...
<a name="svg_line" href="SVG-Shapes#wiki-svg_line">#</a> svg:<b>line</b> x1="0" y1="0" x2="0" y2="0"
...
<a name="svg_path" href="SVG-Shapes#wiki-svg_path">#</a> svg:<b>path</b> d="" transform=""
...
<a name="line" href="SVG-Shapes#wiki-line">#</a> d3.svg.<b>line</b>()
...
<a name="_line_radial" href="SVG-Shapes#wiki-_line_radial">#</a> <b>line</b>(<i>data</i>[, <i>index</i>])

Returns the path data string for the specified array of *data* elements. An optional *index* may be specified, which is passed through to the line's accessor functions.

<a name="line_radial_radius" href="SVG-Shapes#wiki-line_radial_radius">#</a> line.<b>radius</b>([<i>radius</i>])
...
This method is a transformation of the Cartesian [line.x](SVG-Shapes#wiki-line_x) method.

<a name="line_radial_angle" href="SVG-Shapes#wiki-line_radial_angle">#</a> line.<b>angle</b>([<i>angle</i>])
...
<a name="area_x1" href="SVG-Shapes#wiki-area_x1">#</a> area.<b>x1</b>([<i>x1</i>])

…

<a name="area_y" href="SVG-Shapes#wiki-area_y">#</a> area.<b>y</b>([<i>y</i>])

…

<a name="area_y0" href="SVG-Shapes#wiki-area_y0">#</a> area.<b>y0</b>([<i>y0</i>])

If *y0* is specified, sets the *y0*-accessor to the specified function or constant. If *y0* is not specified, returns the current *y0*-accessor. This accessor is invoked for each element in the data array passed to the area generator. The default accessor is the constant zero, thus using a fixed baseline at *y* = 0. For an example of how to specify a *y0*-accessor, see the similar [x](SVG-Shapes#wiki-area_x) accessor.

<a name="area_y1" href="SVG-Shapes#wiki-area_y1">#</a> area.<b>y1</b>([<i>y1</i>])
...
For an example of how to specify a *y1*-accessor, see the similar [x](SVG-Shapes#wiki-area_x) accessor. Note that, like most other graphics libraries, SVG uses the top-left corner as the origin and thus higher values of *y* are *lower* on the screen. For visualization we often want the origin in the bottom-left corner instead; one easy way to accomplish this is to invert the range of the *y*-scale by using range([h, 0]) instead of range([0, h]).
...
<a name="_area_radial" href="SVG-Shapes#wiki-_area_radial">#</a> <b>area</b>(<i>data</i>[, <i>index</i>])

Returns the path data string for the specified array of *data* elements. An optional *index* may be specified, which is passed through to the area's accessor functions.

<a name="area_radial_radius" href="SVG-Shapes#wiki-area_radial_radius">#</a> area.<b>radius</b>([<i>radius</i>])

…

<a name="area_radial_innerRadius" href="SVG-Shapes#wiki-area_radial_innerRadius">#</a> area.<b>innerRadius</b>([<i>radius</i>])

…

<a name="area_radial_outerRadius" href="SVG-Shapes#wiki-area_radial_innerRadius">#</a> area.<b>innerRadius</b>([<i>radius</i>])

…

<a name="area_radial_angle" href="SVG-Shapes#wiki-area_radial_angle">#</a> area.<b>angle</b>([<i>angle</i>])

…

<a name="area_radial_startAngle" href="SVG-Shapes#wiki-area_radial_startAngle">#</a> area.<b>startAngle</b>([<i>angle</i>])

…

<a name="area_radial_endAngle" href="SVG-Shapes#wiki-area_radial_endAngle">#</a> area.<b>endAngle</b>([<i>angle</i>])

…

<a name="arc" href="SVG-Shapes#wiki-arc">#</a> d3.svg.<b>arc</b>()
...
<a name="_arc" href="SVG-Shapes#wiki-_arc">#</a> <b>arc</b>(<i>datum</i>[, <i>index</i>])
...
<a name="arc_innerRadius" href="SVG-Shapes#wiki-arc_innerRadius">#</a> arc.<b>innerRadius</b>([<i>radius</i>])
...
<a name="arc_startAngle" href="SVG-Shapes#wiki-arc_startAngle">#</a> arc.<b>startAngle</b>([<i>angle</i>])
...
<a name="arc_centroid" href="SVG-Shapes#wiki-arc_centroid">#</a> arc.<b>centroid</b>(<i>arguments…</i>)
...
<a name="symbol" href="SVG-Shapes#wiki-symbol">#</a> d3.svg.<b>symbol</b>()
...
<a name="_symbol" href="SVG-Shapes#wiki-_symbol">#</a> <b>symbol</b>(<i>datum</i>[, <i>index</i>])
...
<a name="symbol_type" href="SVG-Shapes#wiki-symbol_type">#</a> symbol.<b>type</b>([<i>type</i>])
...
A chord generator is often used in conjunction with an [arc generator](SVG-Shapes#wiki-arc), so as to draw annular segments at the start and end of the chords. In addition, the [chord layout](Chord-Layout) is useful for generating objects that describe a set of grouped chords from a matrix, compatible with the default accessors.

<a name="_chord" href="SVG-Shapes#wiki-_chord">#</a> <b>chord</b>(<i>datum</i>[, <i>index</i>])
...
<a name="chord_source" href="SVG-Shapes#wiki-chord_source">#</a> chord.<b>source</b>([<i>source</i>])

If *source* is specified, sets the *source*-accessor to the specified function or constant. If *source* is not specified, returns the current *source*-accessor. The purpose of the *source* accessor is to return an object that describes the starting arc of the chord. The returned object is subsequently passed to the [radius](SVG-Shapes#wiki-chord_radius), [startAngle](SVG-Shapes#wiki-chord_startAngle) and [endAngle](SVG-Shapes#wiki-chord_endAngle) accessors. This allows these other accessors to be reused for both the source and target arc descriptions. The default accessor assumes that the input data is an object with suitably-named attributes:
...
<a name="chord_radius" href="SVG-Shapes#wiki-chord_radius">#</a> chord.<b>radius</b>([<i>radius</i>])
...
<a name="chord_startAngle" href="SVG-Shapes#wiki-chord_startAngle">#</a> chord.<b>startAngle</b>([<i>angle</i>])
...
<a name="chord_endAngle" href="SVG-Shapes#wiki-chord_endAngle">#</a> chord.<b>endAngle</b>([<i>angle</i>])
...
<a name="diagonal" href="SVG-Shapes#wiki-diagonal">#</a> d3.svg.<b>diagonal</b>()
...
Although diagonals default to Cartesian (axis-aligned) orientations, they can be used in radial and other orientations using a [projection](SVG-Shapes#wiki-diagonal_projection).

<a name="_diagonal" href="SVG-Shapes#wiki-_diagonal">#</a> <b>diagonal</b>(<i>datum</i>[, <i>index</i>])
...
<a name="diagonal_radial" href="SVG-Shapes#wiki-diagonal_radial">#</a> d3.svg.diagonal.<b>radial</b>()

…

<a name="_diagonal_radial" href="SVG-Shapes#wiki-_diagonal_radial">#</a> <b>diagonal</b>(<i>datum</i>[, <i>index</i>])
