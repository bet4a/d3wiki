...
<br><a name="mondays" href="#wiki-mondays">#</a> d3.time.<b>mondays</b>(<i>start</i>, <i>stop</i>[, <i>step</i>])
<br><a name="tuesdays" href="#wiki-tuesdays">#</a> d3.time.<b>tuesdays</b>(<i>start</i>, <i>stop</i>[, <i>step</i>])
<br><a name="wednesdays" href="#wiki-wednesdays">#</a> d3.time.<b>wednesdays</b>(<i>start</i>, <i>stop</i>[, <i>step</i>])
<br><a name="thursdays" href="#wiki-thursdays">#</a> d3.time.<b>thursdays</b>(<i>start</i>, <i>stop</i>[, <i>step</i>])
<br><a name="fridays" href="#wiki-fridays">#</a> d3.time.<b>fridays</b>(<i>start</i>, <i>stop</i>[, <i>step</i>])
<br><a name="saturdays" href="#wiki-saturdays">#</a> d3.time.<b>saturdays</b>(<i>start</i>, <i>stop</i>[, <i>step</i>])
