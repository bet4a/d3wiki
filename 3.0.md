...
[ [Japanese] ](https://github.com/mbostock/d3/wiki/JP-3.0)
...
D3’s transitions now bind tweens and other transition states to the DOM, similar to how data is bound to selections. This means you can now _reselect_ scheduled transitions from the DOM and modify them, say for [customized](http://bl.ocks.org/3885705) [axes](http://bl.ocks.org/4323929). You can also inspect them in the JavaScript console for easier debugging.
